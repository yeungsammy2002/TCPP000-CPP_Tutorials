...
void MainFrame::draw_p3()
{
	...
	m_page3->SetBackgroundColour(m_fifth_colour);
	...
	m_title_p3->SetForegroundColour(m_sixth_colour);
	...
	m_message2_p3 = new wxStaticText(m_page3, wxID_ANY, wxString::FromUTF8("借出 - 請先讓職員拍卡"), wxPoint(120, 80));
...
void MainFrame::draw_grid_p3()
{
	...
	m_grid_p3->SetColLabelValue(0, wxString::FromUTF8("借出時間"));
	m_grid_p3->SetColLabelValue(1, wxString::FromUTF8("職員姓名"));
	m_grid_p3->SetColLabelValue(2, wxString::FromUTF8("職員英文姓名"));
	m_grid_p3->SetColLabelValue(3, wxString::FromUTF8("登入名稱"));
	m_grid_p3->SetColLabelValue(4, wxString::FromUTF8("iPad 號碼"));
	m_grid_p3->SetLabelBackgroundColour(m_fifth_colour);
	...
	m_empty_message_p3->SetForegroundColour(m_sixth_colour);
...
void MainFrame::draw_p4()
{
	...
	m_title_p4->SetForegroundColour(m_sixth_colour);
	...
	m_message1_p4->SetForegroundColour(m_sixth_colour);
	...
	m_message2_p4->SetForegroundColour(m_forth_colour);
	...
	m_message3_p4->SetForegroundColour(m_third_colour);
...
void MainFrame::draw_grid_p4()
{
	...
	m_grid_p4->SetColLabelValue(0, wxString::FromUTF8("借出時間"));
	m_grid_p4->SetColLabelValue(1, wxString::FromUTF8("歸還時間"));
	m_grid_p4->SetColLabelValue(2, wxString::FromUTF8("職員姓名"));
	m_grid_p4->SetColLabelValue(3, wxString::FromUTF8("職員英文姓名"));
	m_grid_p4->SetColLabelValue(4, wxString::FromUTF8("登入名稱"));
	m_grid_p4->SetColLabelValue(5, wxString::FromUTF8("iPad 號碼"));
	...
	for (int i = 0; i < total_items; ++i)
	{
		...
		for (int j = 0; j < m_col_num_p4; ++j)
		{
			...
			m_grid_p4->SetCellBackgroundColour(i, j, m_fifth_colour);
	...
	m_empty_message_p4->SetForegroundColour(m_sixth_colour);
